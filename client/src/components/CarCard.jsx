...
const CarCard = ({ car }) => {
  ...
  return (
      ...
      <div onClick={()=> {navigate(`/car-details/${car._id}`); scrollTo(0,0)}} className="group rounded-xl overflow-hidden  hover:translate-y-1 
      transition-all duration-500 cursor-pointer shadow-2xl shadow-blue-300">
